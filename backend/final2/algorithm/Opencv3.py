...
# 特征权重（总和=1）
WEIGHTS = {"brenner": 0.75, "ssim": 0.25}
...
def calculate_composite_score(image_path):
    ...
    try:
        ...
        scores = {"brenner": brenner_gradient(gray), "ssim": ssim_contrast(gray)}
...
if __name__ == "__main__":
    test_image = (
        r"C:\Users\Administrator\Desktop\parttime\data\data\20250408skt0000069.png"
    )
